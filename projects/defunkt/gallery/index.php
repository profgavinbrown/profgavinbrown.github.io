...
<?php
	...
	echo "<center><table border=8 width='85%' bgcolor=silver><tr><td>";
	...
	while ($item = readdir($myDirectory))
	{
		...
		if ( is_dir("$thisdir/$item") )
		{
			...
			if( ($item != "$galleryFiles") && ($item != ".") && ($item != "..") && ($item !=".LMX:") )
			{
				...
				echo "<img src=http://www.cs.man.ac.uk/~gbrown/pics/web/folderIcon.jpg border=0></a><br><big>$shortname</big>";
				echo "</td>\n";
